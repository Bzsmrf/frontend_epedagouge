...
const Formcareer = ({show6,setShow6 }) => {
    const handleClose6 = () => setShow6(false);
    if (!show6) return null;
  ...
  return (
    ...
    <section className={`${styles.boxWidth} ${styles.flexCenter} ${styles.paddingX} ${styles.paddingY} fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex flex-col justify-center items-center `}>
    <button className='text-white place-self-end bg-red rounded py-2 px-2 ' onClick={handleClose6}>close</button>
